...
class ElectronicDensity(object):
    ...
    def _weights(self, element):
        ...
        weights = np.array([atomic_values[element][3], atomic_values[element][5], atomic_values[element][7],
                            atomic_values[element][9], atomic_values[element][11], atomic_values[element][13],
                            atomic_values[element][15]])
        return weights
    ...
    def _valence_weights(self, element):
        ...
        valence_weights = np.array([atomic_values[element][17], atomic_values[element][18], atomic_values[element][19],
                                    atomic_values[element][20], atomic_values[element][21], atomic_values[element][22],
                                    atomic_values[element][23]])
    ...
    def mass_center(self):
        ...
        cm = [np.sum(coord_a[:, 0] * sym_m[:]) / np.sum(sym_m), np.sum(coord_a[:, 1] * sym_m[:]) / np.sum(sym_m),
